                            ...
                            <table class="table table-striped table-bordered table-condensed">
                                ...
                                <c:forEach var="playerGameStats" items="${game.gameStats}" varStatus="status">
                                    <tr class="row">
                                        ...
                                        <td class="span1">
                                            <sf:input path="gameStats[${status.index}].goals" maxlength="2" cssClass="x-small" />
                                        </td>
                                        <td class="span1">
                                            <sf:input path="gameStats[${status.index}].assists" maxlength="2" cssClass="x-small" />
                                        </td>
                                        <td class="span1">
                                            <sf:input path="gameStats[${status.index}].penaltyMinutes" maxlength="2" cssClass="x-small" />
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
